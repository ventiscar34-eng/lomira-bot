...
@client.tree.command(name="skip", name_localizations={"th": "ข้ามเพลง"}, description="ข้ามเพลงปัจจุบันไปเพลงถัดไป")
...
@client.tree.command(name="queue", name_localizations={"th": "คิวเพลง"}, description="ดูรายการเพลงทั้งหมดในคิว")
...
@client.tree.command(name="stop", name_localizations={"th": "หยุดเพลง"}, description="หยุดเล่นเพลง ล้างคิวทั้งหมด และออกจากห้องเสียง")
...
@client.tree.command(name="leave", name_localizations={"th": "ออกจากห้อง"}, description="บังคับให้บอทออกจากห้องเสียง")
...
@client.tree.command(name="addrole", name_localizations={"th": "ให้ยศ"}, description="คำสั่งผู้ดูแลระบบ: มอบยศให้สมาชิก")
...
@client.tree.command(name="removerole", name_localizations={"th": "ถอดยศ"}, description="คำสั่งผู้ดูแลระบบ: ถอดยศออกจากสมาชิก")
...
@client.tree.command(name="kick", name_localizations={"th": "เตะ"}, description="คำสั่งผู้ดูแลระบบ: เตะสมาชิกออกจากเซิร์ฟเวอร์")
...
@client.tree.command(name="ban", name_localizations={"th": "แบน"}, description="คำสั่งผู้ดูแลระบบ: แบนสมาชิกออกจากเซิร์ฟเวอร์")
...
@client.tree.command(name="unban", name_localizations={"th": "ปลดแบน"}, description="คำสั่งผู้ดูแลระบบ: ปลดแบนสมาชิก (ใส่ Discord ID)")
...
@client.tree.command(name="purge", name_localizations={"th": "ลบข้อความ"}, description="คำสั่งผู้ดูแลระบบ: ลบข้อความในช่องแชทตามจำนวนที่ระบุ")
